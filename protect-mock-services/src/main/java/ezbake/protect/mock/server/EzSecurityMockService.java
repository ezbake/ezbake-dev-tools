...
public class EzSecurityMockService extends EzBakeBaseThriftService implements EzSecurity.Iface {
    ...
    @Override
    public Set<String> getAuthorizations(EzSecurityToken ezSecurityToken, TokenType tokenType, String s)
            throws EzSecurityTokenException, UserNotFoundException, TException {
        return null;
    }
